...
class Connection extends \yii\db\Connection
{
    ...
    public $commandClass = 'diandi\swoole\db\Command';
    ...
    protected function createPdoInstance()
    {
        ...
        if ($pdoClass === null) {
            ...
            if (isset($driver)) {
                if($driver === 'mysql'){
                    $pdoClass = 'diandi\swoole\db\mysql\PDO';
//                    $this->commandClass = 'diandi\swoole\db\mysql\Command';
