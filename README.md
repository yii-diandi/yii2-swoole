...
[![Latest Stable Version](https://poser.pugx.org/diandi/yii2-swoole/v/stable.svg)](https://packagist.org/packages/diandi/yii2-swoole)
[![Build Status](https://travis-ci.org/diandi/yii2-swoole.png?branch=master)](https://travis-ci.org/diandi/yii2-swoole)
[![Total Downloads](https://poser.pugx.org/diandi/yii2-swoole/downloads.svg)](https://packagist.org/packages/diandi/yii2-swoole)
...
swoole4请直接使用
```php
    composer require diandi/yii2-swoole
```
...
Server::run($config,function (Server $server){
    ...
    $starter->init = function (\diandi\swoole\bootstrap\BaseBootstrap $bootstrap) {
        ...
        require(__DIR__ . '/vendor/diandi/yii2-swoole/src/Yii.php');
        //原项目的配置文件引入
