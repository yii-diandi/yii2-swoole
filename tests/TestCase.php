...
use diandi\swoole\bootstrap\BaseBootstrap;
use diandi\swoole\server\HttpServer;
...
//        $this->destroyApplication();
    ...
    protected function mockApplication($config = [], $appClass = 'diandi\swoole\bootstrap\WebApp')
    {
    ...
    protected function mockWebApplication($configs = [], $appClass = 'diandi\swoole\bootstrap\WebApp')
    {
        $cf = ArrayHelper::merge(
